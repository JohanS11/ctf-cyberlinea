...
BEGIN {
    ...
    require '/home/chan/ctf/cyberseguridadenlinea/stegh/openssl-3.0.1/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/chan/ctf/cyberseguridadenlinea/stegh/openssl-3.0.1/test/fips-and-base.cnf';
    shift;
